...
function Footer() {
  return (
    <div className="w-full h-screen bg-zinc-700 p-20 flex gap-10">
      <div className="font-grotesk w-1/2 h-full flex flex-col justify-between">
        <div className="headings ">
          <h1 className="text-[8vw] -mb-20 uppercase">Eye-</h1>
          <h1 className="text-[8vw]  uppercase">Opening</h1>
        </div>
        <svg
            width="72"
            height="30"
      ...
      <div className="w-1/2 font-grotesk flex flex-col justify-between">
          <h1 className="text-[8vw] -mb-20 uppercase">Presentations</h1>

          <div className='links font-montreal mt-20'>
            <h3>S:</h3>
            <br />
            <ul>
        ...
        <div className="flex justify-between font-montreal text-slate-400">
          <h3>© Ochi Design 2024</h3>
          <h3><u>Website by Juice</u></h3>
        </div>
      </div>
